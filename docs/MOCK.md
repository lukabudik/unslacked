...
| Messages | **1,230** · 525 thread replies · 1,471 reactions |
| Mentions | **957** user-mentions · 175 msgs with channel-mentions |
| Time span | **36 days (~6 weeks)** |
| Routing signal | concentrates on leads/heads (Payments Lead 91×, CEO 86×, Platform Lead 75×) ✅ |

Verdict: reads as a believable **mid-enterprise** workspace with a dense, organic
routing graph. The remaining gaps are UI features (Wave 3) and optional volume.
